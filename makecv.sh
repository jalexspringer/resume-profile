#!/bin/bash
pandoc -o resume.html -c resume-css-stylesheet.css source/resume.md
pandoc -o cc_sales.html -c resume-css-stylesheet.css source/cc_sales.md
pandoc -o index.html -c resume-css-stylesheet.css source/letter_template.md
...
wkhtmltopdf resume.html ASpringerResume.pdf
